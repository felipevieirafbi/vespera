  ...
  const upgradeDefinitions: UpgradeDefinition[] = [
    {
      ...
      subtitle: '+20 HP Máximo Permanente',
    ...
    {
      key: 'damageLevel',
      name: 'Fio da Realidade',
      subtitle: '+15 Dano de Ataque Permanente',
      ...
      getStatText: (lvl) => `${50 + lvl * 15} Dano`,
      getNextStatText: (lvl) => `+15 (${50 + (lvl + 1) * 15} Dano)`,
    },
    {
      key: 'dashLevel',
      name: 'Passos Fantasmas',
      subtitle: '-0.15s Cooldown do Dash Permanente',
      ...
      getStatText: (lvl) => `${Math.max(0.35, 1.0 - lvl * 0.15).toFixed(2)}s Cooldown`,
      getNextStatText: (lvl) => `-0.15s (${Math.max(0.35, 1.0 - (lvl + 1) * 0.15).toFixed(2)}s)`,
    },
  ];
